  ...
  return (
    ...
    >
      ...
      <path
        ...
        fillOpacity="0.2"
      />
      <path fill="currentColor" d="M249.251 18.541c-127.416 0-230.71 103.294-230.71 230.71s103.294 230.711 230.71 230.711c127.416 0 230.71-103.295 230.71-230.711s-103.294-230.71-230.71-230.71z" />
      <path
...
function LowesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        d="M45.625 1C30.875 1 1 1 1 1v41h90V1H45.625z" 
        fill="currentColor"
        opacity="0.2"
      />
      <path fill="currentColor" d="M15 10h5v23h18v5H15V10zm30 5h5v23h-5V15zm10 0h5l5 15 5-15h5v23h-5V20l-5 15h-1l-5-15v18h-5V15zm25 0h8v5h-8v4h8v5h-8v9h-5V15z"/>
    </svg>
  );
}
  ...
  return (
    ...
    >
      <g fill="currentColor" fillRule="nonzero" stroke="none">
        <path d="M548.344 185.95c-38.41-8.1-68.63-52.19-48.31-98.14C187.58 61.91 442.13 49.19 622.19 48.24c7.16 7.8 29.57 31.62 37.02 39.69-30.08 0-36.33-.76-42.9 2.82-23.0 12.54-23.33 45.58 4.26 55.55 15.95 4.98 38.84-4.87 38.84-30.88 0-9.45.24.17-.15-27.5v-36.98h40.24v67.76c0 37.96-35.19 76.28-84.7 67.24M220.12 50.93h41.75v187.25h-41.75V50.93M158.14 50.93h41.77v187.25h-41.77V50.93M373.44 185.65l-27.23-82.45-28.56 82.45h-43.64L324.93 50.93 303.91 0h43.38l69.79 185.65h-43.64M402.38 53.31c-6.76 0-11.92 5.33-11.92 12.39 0 6.92 5.16 12.23 11.92 12.23 6.68 0 11.85-5.32 11.85-12.23 0-7.05-5.17-12.39-11.85-12.39zm0 26.74c-7.91 0-14.55-6.21-14.55-14.35 0-8.29 6.64-14.51 14.55-14.51 7.88 0 14.47 6.22 14.47 14.51 0 8.14-6.6 14.35-14.47 14.35" transform="scale(0.1)" />
        <path d="M402.11 66.58h-2.74v5.35h3.47c1.78 0 3.71-.33 3.71-2.57 0-2.66-2.13-2.78-4.44-2.78zm7.06 2.66c0 3.23-1.89 4.82-5.91 4.82h-6.53V57.2h2.64v7.26h2.78l4.6-7.26h2.81l-4.83 7.46c2.5.27 4.44 1.53 4.44 4.58" transform="scale(0.1)" />
      </g>
    </svg>
  );
}
...
function OpenAIIconBlack(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" viewBox="0 0 256 260" {...props}>
...
function UpstashIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 256 341" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" {...props}>
    ...
    return (
      ...
      >
        <AnimatePresence mode="wait">
          ...
          >
            <CurrentLogo className="h-16 w-16 max-h-[80%] max-w-[80%] object-contain md:h-24 md:w-24 opacity-80 hover:opacity-100 transition-opacity" />
          </motion.div>
        </AnimatePresence>
      </motion.div>
    )
...
function LogoCarousel({ columnCount = 2, logos }: { columnCount?: number; logos: Logo[] }) {
...
export const PartnerLogos: React.FC = () => {
  return (
    <section className="bg-black py-24 border-t border-white/5 relative z-40 overflow-hidden">
